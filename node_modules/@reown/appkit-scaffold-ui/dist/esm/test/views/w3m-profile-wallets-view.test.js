...
import { ChainController, ConnectionController, ConnectionControllerUtil, ConnectorController, CoreHelperUtil, RouterController, SnackController, StorageUtil } from '@reown/appkit-controllers';
...
describe('W3mProfileWalletsView - Tabs Rendering', () => {
    ...
    it('should render tabs with correct mobile width calculation', async () => {
        ...
        const tabs = element.shadowRoot?.querySelector(TABS_COMPONENT);
        expect(tabs).not.toBeNull();
        expect(tabs?.getAttribute('localTabWidth')).toBe('180px');
    });
});
...
describe('W3mProfileWalletsView - Bitcoin Specific Behavior', () => {
    ...
    it('should filter recent connections to only payment accounts for Bitcoin', async () => {
        ...
        expect(recentConnections?.[0]?.getAttribute('address')).toBe('bc1qxy2kgdygjrsqtzq2n0yrf2493p83kkfjhx0wlh');
    });

...
export class AppKitBaseClient {
    constructor(options) {
        ...
        this.getConnections = (namespace) => ConnectionControllerUtil.getConnectionsData(namespace).connections;
        this.getRecentConnections = (namespace) => ConnectionControllerUtil.getConnectionsData(namespace).recentConnections;
        this.switchConnection = params => ConnectionController.switchConnection(params);
        this.deleteConnection = params => StorageUtil.deleteAddressFromConnection(params);
